...
void setup()
{
    ...
    // Correct mapping with fixed wiring:
    // Pico 21 = RX from receiver TX
    // Pico 20 = TX to receiver RX
    Serial.println("[DEBUG] Setting Serial2 pin mapping...");
    Serial2.setRX(21);
    Serial2.setTX(20);
    Serial.println("[DEBUG] Serial2 pins set: RX=21, TX=20");

    Serial.println("[DEBUG] Creating CRSF object...");
    ...
    Serial.println("[DEBUG] CRSF object created");

    Serial.println("[DEBUG] Calling crsf->begin()...");
    bool ok = crsf->begin();
    ...
    Serial.println("[DEBUG] CRSF INITIALIZED OK!");
    Serial.println("[DEBUG] Setting RC callback...");
